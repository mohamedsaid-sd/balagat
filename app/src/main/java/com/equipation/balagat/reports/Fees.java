...
public class Fees extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ar_type_report.add(" رسوم خدمات ");
        ar_type_report.add("  رسوم ادارية ");
        ar_type_report.add("  رسوم ترحيل ");

        ar_type_report.add("  رسوم متأخرات ");
        ...
        ar_evidence.add(" صوره من الفاتورة ");
        ar_evidence.add(" ايصالات ");
