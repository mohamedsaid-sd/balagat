...
public class housing extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ar_type_report.add("  صيانة  ");
        ar_type_report.add(" سباكة  ");
        ar_type_report.add(" كهرباء   ");
        ar_type_report.add("  تكييف ");
        ar_type_report.add(" نظافة   ");
        ar_type_report.add("  ضوضاء ");
        ar_type_report.add("  مشكلة في الجيران  ");
        ar_type_report.add("  مشكلة في ادارة السكن ");
        ar_type_report.add("   اخري ");
