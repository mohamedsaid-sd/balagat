...
public class Operators extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ar_type_report.add("  قيادة متهورة ");
        ar_type_report.add(" تأخير في العمل  ");
        ar_type_report.add(" سوء تعامل  ");
        ar_type_report.add(" عدم الالتزام بالتوجيهات  ");
        ar_type_report.add("  مشكلة نظافة ");
